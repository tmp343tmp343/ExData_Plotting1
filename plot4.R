## Course Project 1, Plot 4, 12 October 2014
...
## Setup a 2x2 space for the 4 plots
par(mfcol=c(2,2))

## Make the plot in the top left
plot(datetime, data2$Global_active_power, type="l", xlab="", # no x-axis label
     ylab="Global Active Power") # customize the y-axis label

## Make the plot in the bottom left
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),
       ...
       bty="n") # removes box around the legend

## Make the plot in the top right
plot(datetime, data2$Voltage, type="l", xlab="datetime", # customize x-axis label
     ylab="Voltage") # customize the y-axis label

## Make the plot in the bottom right
plot(datetime, data2$Global_reactive_power, type="l", 
     xlab="datetime", # customize x-axis label
     ylab="Global_reactive_power") # customize the y-axis label
